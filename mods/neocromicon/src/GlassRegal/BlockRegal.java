...
public class BlockRegal extends ContainerManager
{
    private Random random = new Random();

    public BlockRegal(int var1, int var2)
    {
    ...
    public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5)
    {
        ...
        TileEntityRegal var6 = (TileEntityRegal)var1.getBlockTileEntity(var2, var3, var4);
    ...
    {
        TileEntityRegal var7 = (TileEntityRegal)var1.getBlockTileEntity(var2, var3, var4);
    ...
    {
        Object var10 = (TileEntityRegal)var1.getBlockTileEntity(var2, var3, var4);
        ...
        else
        {
            if (var1.getBlockId(var2 - 1, var3, var4) == this.blockID)
            {
                var10 = new InventoryLargeChest("Large beer barrel", (TileEntityRegal)var1.getBlockTileEntity(var2 - 1, var3, var4), (IInventory)((IInventory)var10));
            }

            if (var1.getBlockId(var2 + 1, var3, var4) == this.blockID)
            {
                var10 = new InventoryLargeChest("Large beer barrel", (IInventory)((IInventory)var10), (TileEntityRegal)var1.getBlockTileEntity(var2 + 1, var3, var4));
            }

            if (var1.getBlockId(var2, var3, var4 - 1) == this.blockID)
            {
                var10 = new InventoryLargeChest("Large beer barrel", (TileEntityRegal)var1.getBlockTileEntity(var2, var3, var4 - 1), (IInventory)((IInventory)var10));
            }

            if (var1.getBlockId(var2, var3, var4 + 1) == this.blockID)
            {
                var10 = new InventoryLargeChest("Large beer barrel", (IInventory)((IInventory)var10), (TileEntityRegal)var1.getBlockTileEntity(var2, var3, var4 + 1));
            }
