...
public class TileEntityRegal extends TileEntity implements IInventory
{
    private ItemStack[] drawerContents = new ItemStack[36];
    public boolean adjacentDrawerChecked = false;
    public TileEntityRegal adjacentChestZNeg;
    public TileEntityRegal adjacentChestXPos;
    public TileEntityRegal adjacentChestXNeg;
    public TileEntityRegal adjacentChestZPos;
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentDrawerChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityRegal)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.worldObj.getBlockId(this.xCoord + 1, this.yCoord, this.zCoord) == BierMod.BlockBierFass.blockID)
            {
                this.adjacentChestXPos = (TileEntityRegal)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord);
            }

            if (this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord - 1) == BierMod.BlockBierFass.blockID)
            {
                this.adjacentChestZNeg = (TileEntityRegal)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord + 1) == BierMod.BlockBierFass.blockID)
            {
                this.adjacentChestZPos = (TileEntityRegal)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord);
            }
