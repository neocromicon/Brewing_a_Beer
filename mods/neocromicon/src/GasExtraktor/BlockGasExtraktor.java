...
public class BlockGasExtraktor extends BlockContainer
{
    private Random gasextraktoRand = new Random();
    private final boolean isActive;
    @SideOnly(Side.CLIENT)
    Icon[] icons;
    private static boolean keepGasExtraktorInventory = false;
    private int counter = 0;

    public BlockGasExtraktor(int var1, boolean var2)
    {
    ...
    {
        return BierMod.GasExtraktorIdle.blockID;
    }
    ...
    {
        this.blockIcon = var1.registerIcon(BierMod.modID + ":GasExtraktor/gasExtraktorTop");
        this.icons = new Icon[3];
        this.icons[0] = var1.registerIcon(BierMod.modID + ":GasExtraktor/gasExtraktorSide");
        this.icons[1] = var1.registerIcon(this.isActive ? BierMod.modID + ":GasExtraktor/gasExtraktorFrontOn" : BierMod.modID + ":GasExtraktor/gasExtraktorFront");
        this.icons[2] = var1.registerIcon(BierMod.modID + ":GasExtraktor/gasExtraktorTop");
    }
    ...
    public boolean onBlockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5, int var6, float var7, float var8, float var9)
    {
        ...
        {
            var5.openGui(BierMod.instance, 11, var1, var2, var3, var4);
            return true;
        }
        else
        {
    ...
    public static void updateFurnaceBlockState(boolean var0, World var1, int var2, int var3, int var4)
    {
        ...
        keepGasExtraktorInventory = true;

        if (var0)
        {
            var1.setBlock(var2, var3, var4, BierMod.GasExtraktorActive.blockID);
        }
        else
        {
            var1.setBlock(var2, var3, var4, BierMod.GasExtraktorIdle.blockID);
        }

        keepGasExtraktorInventory = false;
    ...
    {
        return new TileEntityGasExtraktor();
    }
    ...
    public void onBlockPlacedBy(World var1, int var2, int var3, int var4, EntityLiving var5, ItemStack var6)
    {
        ...
        {
            ((TileEntityGasExtraktor)var1.getBlockTileEntity(var2, var3, var4)).func_94129_a(var6.getDisplayName());
        }
    }
    ...
    {
        if (!keepGasExtraktorInventory)
        {
            TileEntityGasExtraktor var7 = (TileEntityGasExtraktor)var1.getBlockTileEntity(var2, var3, var4);
            ...
            if (var7 != null)
            {
                for (int var8 = 0; var8 < var7.getSizeInventory(); ++var8)
                {
                    ...
                    if (var9 != null)
                    {
                        float var10 = this.gasextraktoRand.nextFloat() * 0.8F + 0.1F;
                        float var11 = this.gasextraktoRand.nextFloat() * 0.8F + 0.1F;
                        float var12 = this.gasextraktoRand.nextFloat() * 0.8F + 0.1F;

                        while (var9.stackSize > 0)
                        {
                            int var13 = this.gasextraktoRand.nextInt(21) + 10;
                            ...
                            float var15 = 0.05F;
                            var14.motionX = (double)((float)this.gasextraktoRand.nextGaussian() * var15);
                            var14.motionY = (double)((float)this.gasextraktoRand.nextGaussian() * var15 + 0.2F);
                            var14.motionZ = (double)((float)this.gasextraktoRand.nextGaussian() * var15);
