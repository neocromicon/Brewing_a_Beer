...
public class BlockHopfen extends BlockFlower
{
    protected Icon[] iconBuffer = new Icon[7];

    public BlockHopfen(int var1)
    {
        super(var1);
    ...
    public void onBlockAdded(World var1, int var2, int var3, int var4)
    {
        ...
        {
            var1.setBlock(var2, var3 + 1, var4, BierMod.BlockHopfenExt.blockID);
    ...
    public ArrayList getBlockDropped(World var1, int var2, int var3, int var4, int var5, int var6)
    {
        ...
        if (var5 == 5)
        {
            var7.add(new ItemStack(BierMod.ItemSamenHopfen, 1));
            var7.add(new ItemStack(BierMod.ItemHopfen, 3));
        }
    ...
    {
        return BierMod.ItemSamenHopfen.itemID;
    }
    ...
    public void updateTick(World var1, int var2, int var3, int var4, Random var5)
    {
        ...
        if (var1.getBlockLightValue(var2, var3 + 1, var4) >= 9)
        {
            ...
            if (var7 == BierMod.BlockHopfenExt.blockID)
            {
    ...
    {
        this.iconBuffer[0] = var1.registerIcon(BierMod.modID + ":Hopfen/PlantHopfen0");
        this.iconBuffer[1] = var1.registerIcon(BierMod.modID + ":Hopfen/PlantHopfen1");
        this.iconBuffer[2] = var1.registerIcon(BierMod.modID + ":Hopfen/PlantHopfen2");
        this.iconBuffer[3] = var1.registerIcon(BierMod.modID + ":Hopfen/PlantHopfen3");
        this.iconBuffer[4] = var1.registerIcon(BierMod.modID + ":Hopfen/PlantHopfen3");
        this.iconBuffer[5] = var1.registerIcon(BierMod.modID + ":Hopfen/PlantHopfen3");
    }
}
