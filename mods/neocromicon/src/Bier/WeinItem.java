...
public class WeinItem extends ItemFood
{
    public String Image;
    ...
    public WeinItem(int var1, int var2, int var3, float var4, boolean var5, String var6)
    {
    ...
    public ItemStack onEaten(ItemStack var1, World var2, EntityPlayer var3)
    {
        ...
        if (var4 == Side.SERVER)
        {
            ...
            {
                PacketDispatcher.sendPacketToPlayer(PacketHandler.getPortPacket(1, 2500, 900, 1100), (Player)var5);
            }

            if (DrunkEffect.getDrunkLevel() == 4)
            {
                PacketDispatcher.sendPacketToPlayer(PacketHandler.getPortPacket(1, 3000, 900, 1100), (Player)var5);
            }
        ...
        else if (var4 == Side.CLIENT)
        {
            ...
            if (DrunkEffect.getDrunkLevel() == 2)
            {
                PacketDispatcher.sendPacketToServer(PacketHandler.getPortPacket(1, 2500, 900, 1100));
            }

            if (DrunkEffect.getDrunkLevel() == 4)
            {
                PacketDispatcher.sendPacketToServer(PacketHandler.getPortPacket(1, 3000, 900, 1100));
            }
        ...
        if (var1.stackSize <= 0)
        {
            return new ItemStack(BierMod.LeeresWeinGlas);
        }
        else
        {
            var3.inventory.addItemStackToInventory(new ItemStack(BierMod.LeeresWeinGlas));
            return var1;
        }
    }
