...
public class GuiGaerTank extends GuiContainer
{
    private TileEntityGaerTank GasExtraktorInventory;

    public GuiGaerTank(InventoryPlayer var1, TileEntityGaerTank var2)
    {
        super(new ContainerGaerTank(var2, var1));
    ...
    {
        this.fontRenderer.drawString(BierMod.BlockGaerTank.getLocalizedName(), 60, 6, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        this.mc.renderEngine.bindTexture("/mods/" + BierMod.modID + "/textures/blocks/GaerTank/gaerTankGui.png");
